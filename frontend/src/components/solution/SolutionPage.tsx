              ...
              <div className='flex flex-col gap-3'>
                  <div className='flex flex-col gap-3 border-b-2 border-main_blue pb-2 w-fit'>
                      ...
                      <div className="text-border_gray flex flex-row">
                          ...
                          <textarea disabled={true} className='border border-light-grey px-2 py-1 rounded-md shadow-md w-72'>{solutionExtended.assignment.taskDescription}</textarea>
                      </div>
                  ...
                  <div className='mt-1'>
                      {solutionExtended.comment.length > 0 && (
                        <div className="text-border_gray flex flex-row">
                            ...
                            <textarea disabled={true} className='border border-light-grey px-2 py-1 rounded-md shadow-md w-72'>{solutionExtended.comment}</textarea>
                        </div>
                      )}
                  </div>
