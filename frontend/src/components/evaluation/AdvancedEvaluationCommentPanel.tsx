...
export const AdvancedEvaluationCommentPanel = (
  ...
  return (
    <div  style={{float:"right", height:"100vh"}} className='flex'>
      <button className={'bg-light_gray h-full w-[20px] pl-[2px] rounded-bl-md rounded-tl-md'} onClick={() => setIsHidden(!isHidden)}>{isHidden ? <IoMdArrowDropright/> : <IoMdArrowDropleft />}</button>
