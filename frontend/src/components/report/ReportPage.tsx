...
export const ReportPage = () =>{
  ...
  return <div>
    ...
    (reportedObject! as AssignmentInterface).max_points !== undefined ?
      <div>
        <div>RAPORT ZADANIA: {(reportedObject! as AssignmentInterface).title} {format(new Date((reportedObject! as AssignmentInterface).completionDatetime.toString()), "dd.MM.yyyy, HH:mm")}</div>
