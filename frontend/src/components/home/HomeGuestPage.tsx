  ...
  return (
    <div className='flex w-screen flex-col items-center text-center font-lato font-normal select-none'>
      ...
      <img className="fixed right-0 top-[12%] scale-50 translate-x-[25%] xl:transform-none -z-50 " src={right_circle}
           alt="Kółko po prawej stronie"></img>
      ...
      <Link to="/register">
        <button type="button"
                className=" bg-main_blue w-40 h-8 rounded-[5px]  xl:w-[288px] xl:h-[56px] text-white xl:text-[28px] hover:bg-hover_blue hover:shadow-md active:shadow-none">Zarejestruj
          się
        </button>
      </Link>
    </div>
