    ...
    <div className='flex w-screen flex-col font-lato font-normal text-sm select-none'>
      ...
      <div className='flex justify-center items-center text-center flex-col'>
        ...
        <form onSubmit={handleSubmit} className='flex flex-col text-center items-center'>
          ...
          />
          <button type="submit"
                  className=' bg-main_blue w-40 h-8 rounded-[5px] xl:rounded-[10px] xl:w-[288px] xl:h-[56px] text-white xl:text-[28px] hover:bg-hover_blue hover:shadow-md active:shadow-none'>Zajerestruj
            się
          </button>
        </form>
      </div>
