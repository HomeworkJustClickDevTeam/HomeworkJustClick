...
public class UserController {
    ...
    public ResponseEntity<AuthenticationResponse> refreshToken(@RequestBody String userMail) {
        return new ResponseEntity<>(authenticationService.refreshToken(userMail), HttpStatus.OK);
    }
}
