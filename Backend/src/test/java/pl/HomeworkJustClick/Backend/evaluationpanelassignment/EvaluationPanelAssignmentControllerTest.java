...
import pl.HomeworkJustClick.Backend.evaluationpanel.EvaluationPanelRepository;
...
public class EvaluationPanelAssignmentControllerTest extends BaseTestEntity {
    @Autowired
