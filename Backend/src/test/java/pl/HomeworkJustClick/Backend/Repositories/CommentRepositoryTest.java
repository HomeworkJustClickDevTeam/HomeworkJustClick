...
public class CommentRepositoryTest {
    ...
    void itShouldGetCommentsByUserId() {
        ...
        expectedList.add(comment4);

        //when
        List<Comment> actual = commentRepository.getCommentsByUser(user.getId());
...
//        expectedList.add(comment4);
        ...
        //when
        List<Comment> actual = commentRepository.getCommentsByUser(user.getId()+10);
...
//        expectedList.add(comment3);
        ...
        //when
        List<Comment> actual = commentRepository.getCommentsByEvaluation(evaluation.getId());
...
//        expectedList.add(comment4);
        ...
        //when
        List<Comment> actual = commentRepository.getCommentsByEvaluation(evaluation2.getId());
    ...
    void itShouldNotGetCommentsByEvaluationId_2() {
        ...
        CommentEvaluation commentEvaluation = new CommentEvaluation(evaluation, comment, "");
        Comment comment2 = new Comment("Tytul", "Opis", user);
        CommentEvaluation commentEvaluation2 = new CommentEvaluation(evaluation2, comment, "");
        Comment comment3 = new Comment("Tytul", "Opis", user);
        CommentEvaluation commentEvaluation3 = new CommentEvaluation(evaluation3, comment, "");
        Comment comment4 = new Comment("Tytul", "Opis", user);
        CommentEvaluation commentEvaluation4 = new CommentEvaluation(evaluation, comment, "");
        userRepository.save(user);
        userRepository.save(user2);
        userRepository.save(user3);
        groupRepository.save(group);
...
//        expectedList.add(comment4);
        ...
        //when
        List<Comment> actual = commentRepository.getCommentsByUser(evaluation.getId()+100);
...
//        expectedList.add(comment4);
        ...
        //when
        List<Comment> actual = commentRepository.getCommentsByUser(evaluation4.getId());
